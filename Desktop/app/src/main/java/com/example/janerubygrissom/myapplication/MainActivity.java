...
//        Cursor cursor = (Cursor) DBHelper.getInstance(this);
        ...
        inventory.add(new InventoryItem("_________ Prince", "__________ Prince", "The Beautiful Ones",
        ...
        dbHelper.insertMainInventory(new InventoryItem("_________ Prince", "__________ Prince", "The Beautiful Ones",
                "http://www.newyorker.com/wp-content/uploads/2016/04/Prince-Death-Slideshow01-1200x630-1461261685.jpg"));
...
//
//            QuickCardRecyclerAdapter = (RecyclerView) findViewById(R.id.);
...
//
//            Cursor cursor = DBHelper.getPrinceBySearch(query);
...
//            }
//
//            QuickCardRecyclerAdapter foodListCursorAdapter = new QuickCardRecyclerAdapter(this, cursor);
//            QuickCardRecyclerAdapter.setAdapter(foodListCursorAdapter);
//        }
//    }
//
    @Override
